    ...
    <main className="min-h-screen bg-[#0d0f12] text-white">
                ...
                <ul className="space-y-2.5 flex-1 mb-6">
                  {plan.features.map((feat) => (
                    <li key={feat} className="flex items-start gap-2 text-sm text-gray-300">
                      <svg className="w-4 h-4 text-gray-500 mt-0.5 shrink-0" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            {TESTIMONIALS.map((t) => (
              <figure key={t.name} className="rounded-2xl border border-white/8 bg-white/[0.02] p-5 sm:p-6">
                <blockquote>
      ...
      <section className="px-4 sm:px-6 py-12 border-t border-white/8 bg-white/[0.01]">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/saas-cash-flow-forecast" className="rounded-lg border border-white/10 bg-white/[0.03] px-4 py-2.5 text-sm text-gray-400 hover:text-white hover:border-white/20 transition-colors min-h-[44px] flex items-center">
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20 border-t border-white/8">
        <div className="mx-auto max-w-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          ...
          <Link href="/register" className="inline-flex items-center justify-center rounded-lg bg-white px-8 py-3.5 text-sm font-semibold text-black hover:bg-gray-100 active:bg-gray-200 transition-colors min-h-[44px] shrink-0">
            Get Started Free
          </Link>
        </div>
      </section>
