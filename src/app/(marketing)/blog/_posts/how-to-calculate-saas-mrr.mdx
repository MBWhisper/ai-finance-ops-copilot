...
<FaqSchema items={[
  {
    question: "What is the correct formula for SaaS MRR?",
    answer: "MRR = Active Subscribers × Average Revenue Per User (ARPU). For Net New MRR, combine new customer MRR, expansion MRR (upgrades), subtract churned MRR (cancellations), and subtract contraction MRR (downgrades)."
  },
  {
    question: "What should NOT be included in MRR?",
    answer: "Do not include one-time setup fees, professional services, annual plans counted as a single month's payment, refunds, chargebacks, or gift card purchases. Only recurring subscription revenue counts toward MRR."
  },
  {
    question: "How do you count annual plans in MRR?",
    answer: "Divide the annual payment by 12. For example, a $1,188 annual plan represents $99/month in MRR. Never count the full annual payment as a single month's MRR — this will artificially inflate your numbers."
  },
  {
    question: "Why do spreadsheets fail at MRR tracking?",
    answer: "Spreadsheets suffer from stale data, silent formula errors, no audit trail, and hours of manual busywork. They cannot handle recurring data at scale and are error-prone when customers churn mid-month or upgrade between periods."
  },
  {
    question: "What is a common MRR calculation mistake founders make?",
    answer: "The most common mistake is including one-time fees (like setup charges) as recurring revenue. Another frequent error is counting annual plan payments as a single month's MRR instead of normalizing to monthly, and ignoring mid-month churn when customers cancel partway through a billing period."
  }
]} />
