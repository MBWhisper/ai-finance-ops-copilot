...
<FaqSchema items={[
  {
    ...
    answer: "A good monthly churn rate for B2B SaaS is 3-5% (good), 1-2% (great), or below 1% (elite). For revenue churn, below 2-3% monthly is good, under 1% is great, and negative net churn (where expansion exceeds churn) is elite."
  },
  {
    question: "How do you calculate monthly vs annual churn rate?",
    answer: "Monthly churn = (Customers Lost) ÷ (Customers at Start of Month) × 100. Annual churn is NOT monthly × 12 — it compounds: Annual Churn = 1 - (1 - Monthly Churn) ^ 12. So 3% monthly churn becomes 31% annual churn, not 36%."
  },
  {
    question: "What are the most effective ways to reduce SaaS churn?",
    answer: "The 7 most effective tactics are: fix onboarding to reach the aha moment quickly, identify at-risk accounts early via usage signals, offer annual plans with a discount, build engagement loops, make cancellation painless then fix the reason, implement save flows, and measure health scores."
  },
  {
    question: "When is high churn acceptable for a SaaS startup?",
    answer: "Pre-product-market-fit startups may see 5-10% monthly churn. Focus on finding the right customer segment rather than obsessing over churn numbers. Once past PMF, monthly churn above 5% is a crisis that needs immediate attention."
  },
  {
    question: "How does churn impact SaaS revenue over time?",
    answer: "Churn compounds. At 5% monthly churn, you lose approximately 46% of your revenue base annually. Reducing churn from 5% to 2% saves roughly $28,000 per year on a $100K MRR base and requires 60% fewer new customers to maintain growth."
  }
]} />
