...
<FaqSchema items={[
  {
    ...
    answer: "MRR (Monthly Recurring Revenue) measures normalized monthly subscription revenue and is best for day-to-day operations. ARR (Annual Recurring Revenue) is MRR × 12 and is used for fundraising decks, board reporting, and company valuation."
  },
  {
    question: "When should you track MRR vs ARR?",
    answer: "Track MRR daily if you're pre-seed to Series A with ARR under $2M, iterating on pricing, or need early churn warnings. Track ARR monthly if you're Series A+, preparing for fundraising, reporting to a board, or comparing to public SaaS comps."
  },
  {
    question: "How do investors evaluate MRR and ARR?",
    answer: "Investors focus on three things: growth rate (is ARR growing 100%+ YoY?), efficiency (what's your magic number?), and retention (what's your NRR?). A $500K ARR company growing 15% MoM is more interesting than a $2M ARR company growing 5%."
  },
  {
    question: "Can ARR be misleading for growing companies?",
    answer: "Yes. ARR assumes zero growth over the year. If you're growing 10% month-over-month, your current ARR dramatically understates where you'll be in 12 months. That's why growth-stage companies report ARR alongside growth rate."
  },
  {
    question: "What does NRR above 100% mean?",
    answer: "Net Revenue Retention above 100% means your existing customers are spending more over time — you'd grow even with zero new customer acquisition. Above 120% is world-class and indicates strong product-market fit with organic expansion."
  }
]} />
