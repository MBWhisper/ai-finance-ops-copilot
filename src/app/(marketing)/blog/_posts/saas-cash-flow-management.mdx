...
<FaqSchema items={[
  {
    question: "How much cash runway should a SaaS startup have?",
    answer: "Maintain at least 12 months of cash runway at all times. If you're planning to raise funding, extend to 18+ months to give yourself enough time to close a round without desperation-driven dilution."
  },
  {
    question: "What is a healthy burn rate for a SaaS company?",
    answer: "Net burn should be under 10% of your cash balance per month. More importantly, track your burn multiple — spending under $1 to generate $1 of new ARR is strong. A burn multiple above 2x indicates inefficient spending."
  },
  {
    question: "How do you build a 90-day cash flow forecast for SaaS?",
    answer: "Start with your cash position, project revenue inflows (MRR × growth rate minus churn), project cash outflows (payroll, infrastructure, marketing, tools), calculate the monthly cash position, and run three scenarios: base, downside (30% slower growth + 50% higher churn), and upside."
  },
  {
    question: "When should a SaaS company raise funding vs cut costs?",
    answer: "Raise if growth is strong (20%+ monthly MRR), the market is large, and you have 12-18 months to close a round. Cut if growth has slowed below 10% monthly, you haven't found product-market fit, or you can reach profitability by reducing burn."
  },
  {
    question: "Why does high growth sometimes create cash flow problems in SaaS?",
    answer: "Growth accelerates spending — you pay for marketing and sales before customers generate revenue. A $1,200/year customer only pays $100/month, so revenue is delayed while acquisition costs are front-loaded. CAC payback periods of 12-18 months are common."
  }
]} />
