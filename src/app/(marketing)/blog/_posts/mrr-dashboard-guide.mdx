...
<FaqSchema items={[
  {
    question: "What is an MRR dashboard?",
    answer: "An MRR dashboard is a real-time analytics view that automatically tracks your Monthly Recurring Revenue and related metrics — new MRR, expansion MRR, contraction MRR, churned MRR, and net new MRR — pulling data directly from your payment processor like Stripe or PayPal."
  },
  {
    question: "How often should you check your MRR dashboard?",
    answer: "Check your MRR dashboard at least weekly. Daily monitoring helps you spot churn spikes and expansion opportunities before they compound. Real-time visibility allows you to react to problems faster than monthly reviews."
  },
  {
    question: "What is the difference between MRR and ARR?",
    answer: "MRR (Monthly Recurring Revenue) is your normalized monthly subscription revenue. ARR (Annual Recurring Revenue) is MRR × 12, representing the annualized run-rate. Use MRR for day-to-day operational tracking and ARR for fundraising and board reporting."
  },
  {
    question: "Why does Stripe's built-in MRR report show inaccurate numbers?",
    answer: "Stripe calculates MRR from subscription objects, not paid invoices. This causes errors with annual plan normalization, free trials appearing as revenue, discount period inflation, and multi-currency fluctuations. A dedicated MRR dashboard calculates from actual paid invoices."
  },
  {
    question: "What MRR metrics should an MRR dashboard include?",
    answer: "An effective MRR dashboard should show: Total MRR, New MRR, Expansion MRR, Contraction MRR, Churned MRR, Net New MRR, MRR growth rate, churn rate, ARPU, LTV, and a trend chart. Cash flow forecasting and cohort retention views add further operational value."
  }
]} />
