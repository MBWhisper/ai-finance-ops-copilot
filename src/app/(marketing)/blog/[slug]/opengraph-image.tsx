...
export default async function Image({ params }: { params: { slug: string } }) {
  ...
  const title = post?.title ?? 'AI Finance Ops Blog'
  const description = post?.description ?? 'SaaS financial intelligence for early-stage founders.'
            ...
            {tags.slice(0, 3).map((tag) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: '999px',
                  padding: '4px 14px',
                  color: gradStart === '#01696f' ? '#4f98a3' : '#a0b4c0',
                  fontSize: '13px',
                  fontWeight: 500,
