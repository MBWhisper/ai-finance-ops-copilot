...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co https://api.lemonsqueezy.com https://cdn.plaid.com https://www.google-analytics.com https://analytics.google.com https://accounts.google.com https://github.com wss://*.supabase.co",
      "frame-src 'self' https://js.lemonsqueezy.com https://app.lemonsqueezy.com https://cdn.plaid.com https://accounts.google.com https://github.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
